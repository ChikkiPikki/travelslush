...
const products = [
  {
    name: 'Maldives',
    description: 'Starting at ₹50,000 for 5D5N',
    href: '#',
    icon: ChartPieIcon,
  },
  {
    name: 'Goa',
    description: 'Starting at ₹13,000 for 4D4N',
    href: '#',
    icon: CursorArrowRaysIcon,
  },
  { name: 'Ooty', description: 'Starting at ₹50,000 for 5D5N', href: '#', icon: FingerPrintIcon },
  {
    name: 'Sri Lanka',
    description: 'Starting at ₹50,000 for 5D5N',
    href: '#',
...
const callsToAction = [
  { name: 'View Reviews', href: '#', icon: PlayCircleIcon },
  { name: 'Contact sales', href: '#', icon: PhoneIcon },
  { name: 'View all Packages', href: '#', icon: RectangleGroupIcon },
]
